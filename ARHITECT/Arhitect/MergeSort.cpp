...
trud MergeSort(vector<int>& mass)
{
    ...
    while (Step < mass.size())
    {
        ...
        while (leftID < mass.size())
        {
            ...
            // Çàïîëíÿåì ðåçóëüòèðóþùèé ìàññèâ, ïîêà ëåâûé ýëåìåíò íå äîø¸ë äî ñåðåäèíû è ïðàâûé íå äîø¸ë äî êîíöà
            ...
            // Ïåhåìåùåíèå íà ñëåäóþùèé ñîðòèðóåìûé ó÷àñòîê
            leftID += Step * 2;
            middleID += Step * 2;
            rightID += Step * 2;
